...
mod tests {
    ...
    fn engine_implements_matching_engine_process_signature() {
        // Given: a gloomio engine instance
    ...
    #[test]
    #[should_panic(expected = "Implement gloomio matching engine logic")]
    fn engine_process_todo_panics_in_test_that_catches_should_panic() {
        // Given: a gloomio engine
        let mut engine = Engine::for_test();
    ...
    /// Test that GloomioMatchingEngineBuilder still builds an Engine.
    #[test]
